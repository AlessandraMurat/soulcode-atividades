...
export class ConversorService {
  ...
  private readonly BASE_URL = "http://data.fixer.io/api/latest?access_key=88e8eb3d609ec1921d2a61648a0dc5da";
...
cotacaoDe(
  conversaoResponse: ConversaoResponse, conversao: Conversao): string {
    if (conversaoResponse === undefined) {
      return '0';
    }
